...
void _exports_GradidoTransaction_inst::GetMembers(
  ...
  members.insert({
    "isTheSame",
      _exports_GradidoTransaction_templ::InstanceMethod("isTheSame",
        &_exports_GradidoTransaction_templ::_wrap_GradidoTransaction_isTheSame,
        static_cast<napi_property_attributes>(napi_writable | napi_configurable))
    });
  // jsnapi_register_member_function
  ...
  members.insert({
    "toJson",
      _exports_GradidoTransaction_templ::InstanceMethod("toJson",
        &_exports_GradidoTransaction_templ::_wrap_GradidoTransaction__wrap_GradidoTransaction_toJson,
        static_cast<napi_property_attributes>(napi_writable | napi_configurable))
    });
