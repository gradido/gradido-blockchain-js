...
void _exports_TimepointInterval_inst::GetMembers(
  ...
  members.insert({
    "equal",
      _exports_TimepointInterval_templ::InstanceMethod("equal",
        &_exports_TimepointInterval_templ::_wrap_TimepointInterval_equal,
        static_cast<napi_property_attributes>(napi_writable | napi_configurable))
    });
  // jsnapi_register_member_function
  ...
  members.insert({
    "notEqual",
      _exports_TimepointInterval_templ::InstanceMethod("notEqual",
        &_exports_TimepointInterval_templ::_wrap_TimepointInterval_notEqual,
        static_cast<napi_property_attributes>(napi_writable | napi_configurable))
    });
  // jsnapi_register_member_function
  members.erase("begin");
  members.insert({
    "begin",
      _exports_TimepointInterval_templ::InstanceMethod("begin",
        &_exports_TimepointInterval_templ::_wrap_TimepointInterval_begin,
        static_cast<napi_property_attributes>(napi_writable | napi_configurable))
    });
  // jsnapi_register_member_function
  members.erase("end");
  members.insert({
    "end",
      _exports_TimepointInterval_templ::InstanceMethod("end",
