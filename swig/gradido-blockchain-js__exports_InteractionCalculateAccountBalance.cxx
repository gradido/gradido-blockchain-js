...
void _exports_InteractionCalculateAccountBalance_inst::GetMembers(
  ...
  members.insert({
    "run",
      _exports_InteractionCalculateAccountBalance_templ::InstanceMethod("run",
        &_exports_InteractionCalculateAccountBalance_templ::_wrap_InteractionCalculateAccountBalance__wrap_InteractionCalculateAccountBalance_run,
